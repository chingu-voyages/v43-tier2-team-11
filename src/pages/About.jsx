  ...
  return (
    <div className="about">
      ...
      <div className="about__topInfo">
        ...
        <p>
          4foodies began when a group of talented developers from around the
          world participated in Chingu Voyage, a 6-week program where
          participants work in small teams to build a real-world project from
          scratch.
        </p>
        <a href="https://chingu.io" target="_blank">
          learn more about chingu
        </a>
      </div>
      ...
      <div className="about__midContent">
        ...
        <div className="about__cardContainer">
          <div className="about__card">
            ...
            <p>
              you can easily search for nearby restaurants based on your
          ...
          <div className="about__card">
            ...
            <p>
              provides detailed information on each restaurant, reviews,
              categories, This helps users make informed decisions about where
              to eat.
            </p>
          </div>
          <div className="about__card">
            ...
            <p>
              you no longer need to waste time browsing multiple websites or
              walking around aimlessly looking for a place to eat.
            </p>
          </div>
          <div className="about__card">
            ...
            <h4>Map View</h4>
            <p>
              includes a map view that shows the location of each restaurant,
              making it easy to find nearby options and plan your route.
            </p>
          </div>
        </div>
      </div>
      <div className="about__team">
        <h3>Team members</h3>
        <div className="about__container">{profileElement}</div>
      </div>
      <Footer />
    </div>
  );
